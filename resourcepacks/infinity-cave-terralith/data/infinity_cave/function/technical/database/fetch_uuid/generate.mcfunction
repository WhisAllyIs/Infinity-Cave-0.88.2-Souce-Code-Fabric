...
execute unless score @s ic.uuid.0 matches -2147483648.. run function infinity_cave:technical/database/fetch_uuid/zzz/store_uuid

execute store result score 0= ic.main run scoreboard players operation 1= ic.main = @s ic.uuid.0
...
execute store result score 0= ic.main run scoreboard players operation 1= ic.main = @s ic.uuid.1
...
execute store result score 0= ic.main run scoreboard players operation 1= ic.main = @s ic.uuid.2
...
execute store result score 0= ic.main run scoreboard players operation 1= ic.main = @s ic.uuid.3
