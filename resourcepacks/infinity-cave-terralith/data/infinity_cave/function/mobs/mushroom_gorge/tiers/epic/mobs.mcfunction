data modify storage infinity_cave:mushroom_gorge data.epic set value {\
  "mobs": {\
    "1": {\
      "id": "mooshroom",\
      ...
      "tags": "\"ic.ability\",\"ic.melee\",\"epic\",\"mooshroom\"",\
      "name": "Mooshroom",\
      "enchant": 4,\
      "prefix": {\
        "color": "dark_red",\
    ...
    "7": {\
      ...
      "tags": "\"ic.ability\",\"ic.melee\",\"epic\",\"giant_frog\"",\
      "name": "Giant Frog",\
      "enchant": 4,\
      "prefix": {\
        "color": "dark_red",\
    ...
    "9": {\
      ...
      "passengers": [\
        {\
          "CustomName": { "color": "dark_red", "text": "Epic Geraldo" },\
      ...
      "tags": "\"ic.ability\",\"ic.melee\",\"epic\",\"geraldo\"",\
      "name": "Geraldo",\
      "enchant": 4,\
      "prefix": {\
        "color": "dark_red",\
...
execute store result storage infinity_cave:mushroom_gorge data.epic.entries int 1 run data get storage infinity_cave:mushroom_gorge data.epic.mobs