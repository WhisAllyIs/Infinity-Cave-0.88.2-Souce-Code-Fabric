data modify storage infinity_cave:deep_dark data.common set value {\
  "mobs": {\
    "1": {\
      "id": "zombie",\
      "biome": "deep_dark",\
...
execute store result storage infinity_cave:deep_dark data.common.entries int 1 run data get storage infinity_cave:deep_dark data.common.mobs