data modify storage infinity_cave:deeprock_caverns data.uncommon set value {\
  "mobs": {\
    "1": {\
      "id": "zombie",\
...
execute store result storage infinity_cave:deeprock_caverns data.uncommon.entries int 1 run data get storage infinity_cave:deeprock_caverns data.uncommon.mobs