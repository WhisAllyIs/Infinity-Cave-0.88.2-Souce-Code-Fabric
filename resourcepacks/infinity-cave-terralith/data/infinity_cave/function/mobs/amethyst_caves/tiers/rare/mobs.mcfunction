data modify storage infinity_cave:amethyst_caves data.rare set value {\
  "mobs": {\
    "1": {\
      "id": "zombie",\
    ...
    "10": {\
      ...
      "feet": {\
        ...
        "minecraft:trim":{material:"minecraft:amethyst",pattern:"minecraft:silence"},\
          "minecraft:enchantments": {\
            "infinity_cave:technical/ai/_all": 3,\
            "infinity_cave:technical/ai/magician": 1\
          }\
        }\
      },\
      "mainhand": {\
      ...
      "silent": 0,\
      "passengers": {}, \
      "tags": "\"ic.ability\",\"ic.ranged\",\"ic.magician\",\"rare\"",\
      "name": "Magician",\
      "enchant": 3,\
      "prefix": {\
        "color": "blue",\
...
execute store result storage infinity_cave:amethyst_caves data.rare.entries int 1 run data get storage infinity_cave:amethyst_caves data.rare.mobs