...
$data modify storage infinity_cave:mob data set from storage infinity_cave:amethyst_caves data.legendary.mobs.$(int)
...
data modify storage infinity_cave:mob data.persistence set value 1b
