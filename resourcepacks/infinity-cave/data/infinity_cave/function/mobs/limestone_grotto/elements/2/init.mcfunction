...
data merge storage infinity_cave:main {color:"yellow",style:"notched_20"}
function infinity_cave:technical/bossbar/get_data with storage infinity_cave:main

scoreboard players set @s ic.tagged 1

execute if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{passenger:{}}} on passengers run return run function infinity_cave:mobs/limestone_grotto/elements/2/passenger