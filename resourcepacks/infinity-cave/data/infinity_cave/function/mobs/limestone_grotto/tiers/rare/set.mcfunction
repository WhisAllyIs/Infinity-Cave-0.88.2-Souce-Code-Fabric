$data modify storage infinity_cave:mob data set from storage infinity_cave:limestone_grotto data.rare.mobs.$(int)
...
particle flash{color:[1.000,1.000,1.000,1.00]} ~ ~0.8 ~ 0.25 0.25 0.25 0.25 10 force
