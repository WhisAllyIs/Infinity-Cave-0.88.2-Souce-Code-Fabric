...
execute if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{passenger:{}}} on passengers run return run function infinity_cave:mobs/frozen_caves/elements/2/passenger