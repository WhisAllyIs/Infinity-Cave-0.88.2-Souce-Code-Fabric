data modify storage infinity_cave:sulfide_caves data.uncommon set value {\
  "mobs": {\
    "1": {\
      "id": "zombie",\
      "biome": "sulfide_caves",\
...
execute store result storage infinity_cave:sulfide_caves data.uncommon.entries int 1 run data get storage infinity_cave:sulfide_caves data.uncommon.mobs