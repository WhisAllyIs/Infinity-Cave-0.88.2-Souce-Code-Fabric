...
execute if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{passenger:{}}} on passengers run return run function infinity_cave:mobs/deep_dark/elements/1/passenger
