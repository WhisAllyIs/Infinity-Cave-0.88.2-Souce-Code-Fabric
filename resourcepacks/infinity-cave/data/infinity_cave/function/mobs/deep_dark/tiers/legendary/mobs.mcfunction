data modify storage infinity_cave:deep_dark data.legendary set value {\
  "mobs": {\
    "1": {\
      "id": "ravager",\
      "biome": "deep_dark",\
    ...
    "3": {\
      ...
      "tier": "legendary",\
      "health_factor": 2.2,\
      "attack_damage_factor": 0.4,\
      "speed_factor": 0.006,\
      "attack_knockback_factor": 0.04,\
      "scale_factor": 0.01,\
      "knockback_resistance": 0.009,\
      "head": {\
...
execute store result storage infinity_cave:deep_dark data.legendary.entries int 1 run data get storage infinity_cave:deep_dark data.legendary.mobs