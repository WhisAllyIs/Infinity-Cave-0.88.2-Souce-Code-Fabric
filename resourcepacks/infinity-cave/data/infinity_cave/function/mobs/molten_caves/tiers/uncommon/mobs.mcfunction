data modify storage infinity_cave:molten_caves data.uncommon set value {\
  "mobs": {\
    "1": {\
      "id": "zombified_piglin",\
      "biome": "molten_caves",\
    ...
    "8": {\
      ...
      "mainhand": {\
        ...
        "components": {\
          ...
          "minecraft:enchantments": {\
            "infinity_cave:technical/ai/fire_archer": 2\
          }\
        }\
      },\
      "offhand": [\
      ...
      "silent": 0,\
      "passengers": {}, \
      "tags": "\"ic.ability\",\"ic.melee\",\"uncommon\",\"fire_archer\"",\
      "name": "Fire Archer",\
      "enchant": 2,\
      "prefix": {\
        "color": "green",\
...
execute store result storage infinity_cave:molten_caves data.uncommon.entries int 1 run data get storage infinity_cave:molten_caves data.uncommon.mobs