advancement revoke @s only infinity_cave:mechanics/rc/repel/_offhand

data modify storage ic:items repel set from entity @s equipment.offhand.components."minecraft:custom_data".infinity_cave
